...
public class OrangePortalEntity extends Entity implements IAnimatable {
	private final AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private static final DataParameter<Integer> TICK_COUNT = EntityDataManager.defineId(OrangePortalEntity.class, DataSerializers.INT);
	private static final DataParameter<Integer> AMOUNT_TELEPORTED_ENTITIES = EntityDataManager.defineId(OrangePortalEntity.class, DataSerializers.INT);
	private static final DataParameter<Optional<BlockPos>> DESTINATION_POS = EntityDataManager.defineId(OrangePortalEntity.class, DataSerializers.OPTIONAL_BLOCK_POS);
	private final IntArrayList teleportedEntities = new IntArrayList();
	
	public OrangePortalEntity(EntityType<?> pType, World pLevel) {
		super(pType, pLevel);
	}
